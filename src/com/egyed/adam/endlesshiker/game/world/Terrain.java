...
public class Terrain {
  ...
  public Mesh init() throws Exception {
    ...
    return new Mesh(vertices, textureCoords, indices, new Texture("/res/texture/grasstile.png"));
  }
}
